...
class GoogleMaps {
	...
	/**
	 * Private constructor. This class contains only static functions, hence there is no instantiation neccessary.
	 */
	...
	/**
	 * Let Google calculate e distance between two coordinates. This function calculates the distance using existing roads.
	 * Linear distance can be calculated using the MapRadius class.
	 * @param Float $lat_dep Latitude start point
	 * @param Float $lng_dep Longitude start point
	 * @param Float $lat_dest Latitude end point
	 * @param Float $lng_dest Longitude end point
	 * @return The whole dataset received from Google.
	 */
